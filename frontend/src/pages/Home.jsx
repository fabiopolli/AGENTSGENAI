...
export default function Home() {
  ...
  const handleSend = async (input) => {
    ...
    try {
      ...
      setResponse(data?.response?.response || "Erro ao processar a resposta.");
    } catch (error) {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 p-4">
      ...
      {response && (
        <div className="mt-4 p-4 bg-white shadow rounded w-full max-w-2xl border border-gray-300 text-center">
